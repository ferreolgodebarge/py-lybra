...
import py_libra.protos.src_mempool_status_pb2 as src__mempool__status__pb2
import py_libra.protos.transaction_pb2 as transaction__pb2
import py_libra.protos.vm_errors_pb2 as vm__errors__pb2
...
_SUBMITTRANSACTIONRESPONSE.fields_by_name['mempool_status'].enum_type = src__mempool__status__pb2._MEMPOOLADDTRANSACTIONSTATUS
