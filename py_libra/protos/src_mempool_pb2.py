...
_ADDTRANSACTIONWITHVALIDATIONRESPONSE.fields_by_name['status'].enum_type = src__mempool__status__pb2._MEMPOOLADDTRANSACTIONSTATUS
...
AddTransactionWithValidationRequest = _reflection.GeneratedProtocolMessageType('AddTransactionWithValidationRequest', (_message.Message,), dict(
  DESCRIPTOR = _ADDTRANSACTIONWITHVALIDATIONREQUEST,
  __module__ = 'src_mempool_pb2'
...
AddTransactionWithValidationResponse = _reflection.GeneratedProtocolMessageType('AddTransactionWithValidationResponse', (_message.Message,), dict(
...
TransactionExclusion = _reflection.GeneratedProtocolMessageType('TransactionExclusion', (_message.Message,), dict(
...
CommitTransactionsRequest = _reflection.GeneratedProtocolMessageType('CommitTransactionsRequest', (_message.Message,), dict(
...
CommitTransactionsResponse = _reflection.GeneratedProtocolMessageType('CommitTransactionsResponse', (_message.Message,), dict(
...
CommittedTransaction = _reflection.GeneratedProtocolMessageType('CommittedTransaction', (_message.Message,), dict(
